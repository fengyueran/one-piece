...
- [ ] **Phase 1: 公开契约与发布基线** - 收口 `compass-ui` 的公开导出、消费方式和发布前校验基线。
- [ ] **Phase 2: 文档入口与验证统一** - 把文档、demo 与测试链路统一到真实公开消费路径。
...
| --------------------- | -------------- | ----------- | --------- |
| 1. 公开契约与发布基线 | 0/TBD          | Not started | -         |
| 2. 文档入口与验证统一 | 0/TBD          | Not started | -         |
| 3. 基础组件补齐       | 0/TBD          | Not started | -         |
